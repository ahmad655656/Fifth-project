...
export default function Questions(props) {
  return (
    <div className="w-[400px] h-[10px] flex flex-col shadow-shadowFqs shadow-shadowFqs hover:shadow-none gap-[40px] transition-all duration-300 ease-in-out hover:h-[350px] p-[20px] bg-bgTheardSection items-center border-solid border-[2px] border-borderButton ">
