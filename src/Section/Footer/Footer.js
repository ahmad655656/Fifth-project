    ...
    <div className="w-maxWidth lg:max-xlg:absolute sm:max-md:pr-0 pr-[10px] bottom-0 sm:max-md:w-widthMobile sm:max-md:h-[300px] h-[589px] ">
      <div className="w-[1240px] h-[180px] sm:max-md:h-[293px] sm:max-md:mr-[23px] sm:max-md:w-[358px] sm:max-md:flex-col mr-[140px] sm:max-md:items-center sm:max-md:m-auto m-auto sm:max-md:translate-y-[140px] translate-y-[80px] flex flex-row items-center rounded-[20px] bg-bgNav text-secondTextColor sm:max-md:px-[10px] sm:max-md:py-[20px] px-[36px] py-[64px] justify-between ">
        ...
        <div className="w-[349px] sm:max-md:w-[311px] h-[108px] flex flex-col items-center gap-[20px] ">
          <div className="w-[349px] sm:max-md:w-[311px] sm:max-md:h-[42px] h-[48px] bg-bgMainSection rounded-[62px] gap-[10px] text-center pl-[10px] flex flex-row items-center">
        ...
        <div className="w-[1240px] h-[207px] m-auto flex flex-row sm:max-md:min-h-[650px] sm:max-md:pl-[30px] sm:max-md:pb-0 sm:max-md:flex-wrap sm:max-md:w-widthMobile sm:max-md:pb-[40px] border-b-solid border-b-[2px] pb-[100px] border-b-borderFooter items-center justify-between">
          <div className="w-[248px] h-[177px] sm:max-md:w-widthMobile flex flex-col items-start gap-[35px] ">
            ...
            <span className="flex flex-row items-center w-[184px] sm:max-md:w-[148px] h-[28px] gap-[12px] hover:gap-[20px] transition-all duration-500 ease-in-out ">
              ...
              <GitHub className="hover:w-[38px] hover:h-[38px] transition-all duration-500 ease-in-out w-[28px] bg-bgTheardSection h-[28px] rounded-[50%] cursor-pointer text-firstTextColor text-[15px] p-[4px] " />
            </span>
          </div>
          <div className="w-[104px] h-[177px] sm:max-md:w-[50%] sm:max-md:h-[146px] sm:max-md:gap-[10px] flex flex-col items-start gap-[26px] ">
            <h2 className="text-[16px] sm:max-md:text-[14px] text-firstTextColor font-medium ">
              COMPANY
            </h2>
            <div className="flex flex-col items-start gap-[16px]">
              <h4 className="text-[16px] text-secondTextColor sm:max-md:text-[14px] font-light opacity-60 ">
                About
              </h4>
              <h4 className="text-[16px] text-secondTextColor  sm:max-md:text-[14px] font-light opacity-60 ">
                Features
          ...
          <div className="w-[136px] h-[177px] sm:max-md:w-[50%] text-firstTextColor  sm:max-md:h-[146px] sm:max-md:gap-[10px] flex flex-col items-start gap-[26px] ">
          ...
          <div className="w-[149px] h-[177px] sm:max-md:w-[50%] sm:max-md:h-[146px] sm:max-md:gap-[10px] flex flex-col items-start gap-[26px] ">
            <h2 className="text-[16px] text-firstTextColor  sm:max-md:text-[14px] font-medium ">
              FAQ
            </h2>
            <div className="flex flex-col items-start gap-[16px] ">
              <h4 className="text-[16px] text-secondTextColor  sm:max-md:text-[14px] font-light opacity-60 ">
